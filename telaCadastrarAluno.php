        ...
        <div class="container panel panel-default">
				...
				<div class="panel panel-default jumbotron">	
					...
					<div class="input-group">
	  					...
	  					<input type="text" class="form-control"  id="login" name="login" placeholder="Digite o login" aria-describedby="sizing-addon2">
					</div>
                                        
                                        <div class="input-group">
	  					<span class="input-group-addon" id="sizing-addon2">Senha</span>
	  					<input type="text" class="form-control"  id="senha" name="senha" placeholder="Digite a senha" aria-describedby="sizing-addon2">
					</div>
